T  = "\033[90;1m" # dark
f  = "\033[96;1m" # Blue aqua
m  = "\033[34;1m" # Blue light
...
def Genocide():
      ...
      print R+"          oooooooo        "
      print R+"         ooo___ooo        "
      print R+"      ooooooooooooooo     "
      print R+"     ooooooooooooooooo    "
      print R+"    ooooooooooooooooooo   "
      os.system("toilet -f big ' Genocide' -F gay | lolcat")
      print R+ "--------------------------------"
      print
      print "  [01]>toolHacker             [02]>IP          "
      print
      print "  [03]>spmmerBT               [04]>+ - * /     "
      print
      print "  [05]>DDOS                   [06]>wphunter    "
      print
